...
<body>
  <header class="header">
    <h1 class="site-title"><a href="#"><img src="images/common/book.png" alt="G's Academy Tokyo"></a></h1>
    <a href="login.php" class="btn btn-cart"><img src="images/common/icon-cart.png" alt="G's Academy Tokyo"></a>
  ...
  <div>
    <ul class="bxslider">
      <li><img src="images/index/book.png" alt=""></li>
      <li><img src="images/index/book2.png" alt=""></li>
      <li><img src="images/index/book3.png" alt=""></li>
    </ul>
  </div>
  ...
  <footer class="footer">
    ...
    <div class="footer-widget__long">
        <p><a href="#"><img src="./images/common/book.png" alt="g's academy tokyo"></a></p>
      </div>

      <div class="footer-widget">
        <ul class="nav-footer">
          <li class="nav-footer__item"><a href="#">History</a></li>
          <li class="nav-footer__item"><a href="#">Medical</a></li>
          <li class="nav-footer__item"><a href="#">Science</a></li>
          <li class="nav-footer__item"><a href="#">Art</a></li>
          <li class="nav-footer__item"><a href="#">hobby</a></li>
        </ul>
      </div>

      <div class="footer-widget">
        <ul class="nav-footer">
          <li class="nav-footer__item"><a href="#">G's Bookstore??</a></li>
